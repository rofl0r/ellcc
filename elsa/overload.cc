...
int compareConversionsTwoSrc(
  ArgumentInfo const &leftSrc, ImplicitConversion const &left, Type const *leftDest,
  ArgumentInfo const &rightSrc, ImplicitConversion const &right, Type const *rightDest);
...
static void resolveOverloadedArgument
  (Env &env, ArgumentInfo &argInfo, Type const *destType)
{
  Variable *v = 
