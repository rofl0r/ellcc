...
// [cppstd 13.4 para 1]
Variable *Env::pickMatchingOverloadedFunctionVar(LookupSet &set, Type const *type)
{
...
Type *Env::sizeofType(Type *t, int &size, Expression * /*nullable*/ expr)
{
  ...
  return t->isError()? t : getSimpleType((SimpleTypeId)TI.getSizeType());
}
...
/** Decode a builtin type from a string.
