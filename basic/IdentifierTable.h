...
/// DenseSets.
template <>
struct DenseMapInfo<ellcc::Selector> {
  static inline ellcc::Selector getEmptyKey() {
    return ellcc::Selector::getEmptyMarker();
  }
  static inline ellcc::Selector getTombstoneKey() {
    return ellcc::Selector::getTombstoneMarker(); 
  }
  
  static unsigned getHashValue(ellcc::Selector S);
  
  static bool isEqual(ellcc::Selector LHS, ellcc::Selector RHS) {
    return LHS == RHS;
  }
...
template<>
class PointerLikeTypeTraits<ellcc::IdentifierInfo*> {
public:
  static inline void *getAsVoidPointer(ellcc::IdentifierInfo* P) {
    return P; 
  }
  static inline ellcc::IdentifierInfo *getFromVoidPointer(void *P) {
    return static_cast<ellcc::IdentifierInfo*>(P);
  }
  enum { NumLowBitsAvailable = 1 };
};

template<>
class PointerLikeTypeTraits<const ellcc::IdentifierInfo*> {
public:
  static inline const void *getAsVoidPointer(const ellcc::IdentifierInfo* P) {
    return P; 
  }
  static inline const ellcc::IdentifierInfo *getFromVoidPointer(const void *P) {
    return static_cast<const ellcc::IdentifierInfo*>(P);
  }
  enum { NumLowBitsAvailable = 1 };
};
