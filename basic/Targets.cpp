...
TargetInfo::RaiseInstructionsList ARMTargetInfo::raiseInstructionsList[] = {
    ...
    { Instruction::FPToUI,      "__fixunssfsi",
                                1, { Type::VoidTyID, Type::FloatTyID }, { 32 } },
    ...
    { Instruction::FPToUI,      "__fixunsdfsi",
                                1, { Type::VoidTyID, Type::DoubleTyID }, { 32 } },
    ...
    { Instruction::FCmp,        "__eqsf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_OEQ },
    { Instruction::FCmp,        "__nesf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_ONE },
    { Instruction::FCmp,        "__gesf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_OGE },
    { Instruction::FCmp,        "__gtsf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_OGT },
    { Instruction::FCmp,        "__lesf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_OLE },
    { Instruction::FCmp,        "__ltsf2",
                                2, { Type::VoidTyID, Type::FloatTyID, Type::FloatTyID }, { 1 },
                                    CmpInst::FCMP_OLT },
