...
void Preprocessor::RegisterBuiltinPragmas() {
  ...
  // #pragma ellcc ...
  AddPragmaHandler("ellcc", new PragmaPoisonHandler(
                                          getIdentifierInfo("poison")));
  AddPragmaHandler("ellcc", new PragmaSystemHeaderHandler(
                                          getIdentifierInfo("system_header")));
  AddPragmaHandler("ellcc", new PragmaDependencyHandler(
                                          getIdentifierInfo("dependency")));
  AddPragmaHandler("ellcc", new PragmaDiagnosticHandler(
                                          getIdentifierInfo("diagnostic")));
