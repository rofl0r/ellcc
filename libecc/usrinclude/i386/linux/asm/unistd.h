#ifndef _I386_LINUX_ASM_UNISTD_H_
#define _I386_LINUX_ASM_UNISTD_H_
...
#define __NR_madvise1 (__NR_SYSCALL_BASE + 219) 
...
#define __NR_timer_settime (__NR_SYSCALL_BASE + )(__NR_timer_create+1)
#define __NR_timer_gettime (__NR_SYSCALL_BASE + )(__NR_timer_create+2)
#define __NR_timer_getoverrun (__NR_SYSCALL_BASE + )(__NR_timer_create+3)
#define __NR_timer_delete (__NR_SYSCALL_BASE + )(__NR_timer_create+4)
#define __NR_clock_settime (__NR_SYSCALL_BASE + )(__NR_timer_create+5)
#define __NR_clock_gettime (__NR_SYSCALL_BASE + )(__NR_timer_create+6)
#define __NR_clock_getres (__NR_SYSCALL_BASE + )(__NR_timer_create+7)
#define __NR_clock_nanosleep (__NR_SYSCALL_BASE + )(__NR_timer_create+8)
...
#define __NR_mq_unlink (__NR_SYSCALL_BASE + )(__NR_mq_open+1)
#define __NR_mq_timedsend (__NR_SYSCALL_BASE + )(__NR_mq_open+2)
#define __NR_mq_timedreceive (__NR_SYSCALL_BASE + )(__NR_mq_open+3)
#define __NR_mq_notify (__NR_SYSCALL_BASE + )(__NR_mq_open+4)
#define __NR_mq_getsetattr (__NR_SYSCALL_BASE + )(__NR_mq_open+5)
...
#define __NR_epoll_create1 (__NR_SYSCALL_BASE + 329)
#define __NR_dup3 (__NR_SYSCALL_BASE + 330)
#define __NR_pipe2 (__NR_SYSCALL_BASE + 331)
#define __NR_inotify_init1 (__NR_SYSCALL_BASE + 332)

#endif // _I386_LINUX_ASM_UNISTD_H_
