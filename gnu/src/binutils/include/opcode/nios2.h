...
struct nios2_opcode
{
  ...
  const char *args_test;	/* Like args, but with an extra argument for 
                                   the expected opcode.  */
  unsigned int num_args;	/* The number of arguments the instruction 
                                   takes.  */
  unsigned int match;		/* The basic opcode for the instruction.  */
  unsigned int mask;		/* Mask for the opcode field of the 
                                   instruction.  */
  unsigned int pinfo;		/* Is this a real instruction or instruction 
			           macro?  */
...
extern const struct nios2_opcode *nios2_find_opcode_hash (unsigned int);
