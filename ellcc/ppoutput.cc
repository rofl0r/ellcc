//===--- ppoutput.cc - Implement the -E mode --------------===//
//
...
#include "../lex/PPCallbacks.h"
#include "../lex/Preprocessor.h"
#include "../lex/Pragma.h"
#include "../lex/TokenConcatenation.h"
...
///
void ellcc::DoPrintPreprocessedInput(Preprocessor &PP, 
  ...
  std::string Err;
  llvm::raw_fd_ostream OS(OutFile.empty() || OutFile == "-" ? "-" : OutFile.c_str(), 
                          Err);
  if (!Err.empty()) {
    fprintf(stderr, "%s\n", Err.c_str());
    exit(1);
